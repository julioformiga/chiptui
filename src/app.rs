...
impl App {
    ...
    fn step_focus_horizontal(&mut self, right: bool) {
        if self.row3_fullscreen {
    ...
    fn on_device_info_key(&mut self, key: KeyEvent) {
    ...
    fn pane_for_number(&self, number: u8) -> Option<Focus> {
        [
            Focus::Project,
            Focus::DeviceInfo,
            Focus::FilesLocal,
    ...
    fn focus_column(focus: Focus) -> Option<bool> {
        match focus {
    ...
    /// Logs.
    fn focusable_in_row(&self, row: u8, right: bool) -> Option<Focus> {
        match row {
            1 => {
    ...
    fn step_focus_vertical(&mut self, down: bool) {
