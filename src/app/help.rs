...
use super::{App, DevicePaneTab, Focus, LogTab, Overlay, View};
...
impl App {
    ...
    pub(super) fn handle_shortcuts_overlay_key(&mut self, key: KeyEvent) -> bool {
    ...
    /// (`footer`): the same declarations the help window lists, so
